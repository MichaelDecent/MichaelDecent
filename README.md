...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Michael%20Nwogha&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Backend%20Engineer%20%C2%B7%20AI%20Engineer&descAlignY=52&descSize=18"/>
...
<a href="https://x.com/michaeldecent0" target="_blank"><img src="https://img.icons8.com/m_rounded/200/FFFFFF/twitterx.png" alt="X" width="42" /></a>
...
```
Python · Go · Node.js · Django · Flask · Express
```
...
Building intelligent systems and exploring AI agents—from LLMs to autonomous workflows that solve real-world problems at scale.

```
AI Agents · LLMs · Python · Machine Learning
```
